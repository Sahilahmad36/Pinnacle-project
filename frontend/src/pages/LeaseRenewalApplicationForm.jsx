import styl from "../assets/img/leave.jpg";
import { MdKeyboardArrowRight } from 'react-icons/md';
import { CgMail } from 'react-icons/cg';
import { useEffect } from "react";
import AOS from "aos";
import "aos/dist/aos.css";
const LeaseRenewalApplicationForm = () => {
  useEffect(() => {
    AOS.init({
      duration: 1200,
    });
    ...
    <>
      <div className="relative h-[40vh] md:min-h-screen flex flex-col justify-center px-4 ">
        ...
        <div
          ...
          >
            <span className='lg:text-6xl text-4xl'>l</span>ease <span className='lg:text-6xl text-4xl'>R</span>enewal <span className='lg:text-6xl text-4xl'>A</span>pplication <br />
      ...
      <div className=' w-[full] md:-mt-[8%] flex items-center justify-center flex-col py-20 mt-8 '>
        <p className='text-[0.8rem] md:text-[1rem] font-[600] text-[#66686B] text-center px-4'>Kindly download the pdf Form and email (fully filled, signed and with the required documents) to the <br /> email addresses below.</p>
        <a
          href="/LEASE-RENEWAL-APPLICATION.pdf"
          target="_blank"
          rel="noopener noreferrer"
          className=' mt-12 flex items-center border-[#C2AB92] text-[#C2AB92] py-2 px-4 text-[0.8rem] md:text-[1rem] border-[2px]'
        >
          Download Lease Renewal Application Form <MdKeyboardArrowRight className='text-[#C2AB92] text-[1rem] md:text-[1.4rem]' /></a>
...
export default LeaseRenewalApplicationForm
