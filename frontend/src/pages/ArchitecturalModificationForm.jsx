...
import styl from "../assets/img/architectural.jpg";
import { MdKeyboardArrowRight } from 'react-icons/md';

const ArchitecturalModificationForm = () => {
    return (
        <div>
            <div className="relative h-[40vh] md:min-h-screen flex flex-col justify-center px-4 ">
                ...
                <div
                    ...
                    >
                        ...
                        <span className='lg:text-6xl text-4xl'>A</span>rchitectural <span className='lg:text-6xl text-4xl'>M</span>odification <br />
            ...
            <div
                className=' w-[full] md:-mt-[8%] flex items-center justify-center flex-col py-20 mt-8 '>
                <p className='text-[0.8rem] md:text-[1rem] font-[600] text-[#66686B] text-center px-4 w-[80%]'>
                    Kindly download the pdf Form and email (fully filled, signed and with the required documents) to the email addresses below.</p>
                <a
                    href="/ARCHITECTURAL-MODIFICATION-FORM-FINAL.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className=' mt-12 flex items-center border-[#C2AB92] text-[#C2AB92] py-2 px-4 text-[0.8rem] md:text-[1rem] border-[2px]'
                >
                    Download Architectural  Modification Form <MdKeyboardArrowRight className='text-[#C2AB92] text-[1rem] md:text-[1.4rem]' />
                </a>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 mt-4 w-[90vw] relative'>
                    <div
                        className='w-[100%] px-4 py-7 shadow-lg flex items-center justify-center flex-col rounded-md hover:bg-gradient-to-r hover:from-yellow-300 hover:to-gray-100 transition-all duration-300'>
...
export default ArchitecturalModificationForm
