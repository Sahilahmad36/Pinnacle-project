...
import styl from "../assets/img/wind.jpg"
import { MdKeyboardArrowRight } from 'react-icons/md'

const WindMitigationReport = () => {
    return (
        <div>
            <div className="relative h-[40vh] md:min-h-screen flex flex-col justify-center px-4  ">
                ...
                <div
                    ...
                    >
                        <span className='lg:text-6xl text-4xl'>MIT II & III</span>  <span className='lg:text-6xl text-4xl'>C</span>over,
                        <span className='lg:text-6xl text-4xl'> MIT II <br /> & III</span> <span className='lg:text-6xl text-4xl'>F</span>orm
                    </h1>
            ...
            <div className=' w-[full] md:-mt-[8%] flex items-center justify-center flex-col py-20 mt-8 '>
                ...
                <a
                    href="/Wind-Mitigation-Report-for-Pinnacle-Condo.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className=' mt-12 flex items-end border-[#C2AB92] text-[#C2AB92] py-2 px-4 text-[0.8rem] font-[600] md:text-[1rem] border-[2px]'
                >
                    Download MIT II & III Cover, MIT II & III Form <MdKeyboardArrowRight className='text-[#C2AB92] text-[1rem] md:text-[1.4rem]' /></a>
...
export default WindMitigationReport
